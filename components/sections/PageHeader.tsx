            ...
            <ScrollReveal delay={0.2}>
              <div className="mt-10 flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4 max-w-md sm:max-w-none">
                <a
                  ...
                  className="group inline-flex items-center justify-center gap-2.5 bg-whatsapp hover:bg-whatsapp-deep text-walnut-deep font-semibold text-[14.5px] px-6 py-3.5 rounded-lg transition-all duration-200 shadow-sm hover:shadow hover:shadow-whatsapp/20 hover:-translate-y-0.5 active:translate-y-0 active:scale-[0.98]"
                >
