...
const plans = [
  ...
  { name: "Kashi darshan circuit", duration: "~6–8 hours", coverage: "Kashi Vishwanath, Sankat Mochan, Durga Temple, Tulsi Manas, BHU New Vishwanath", fit: "SUV/MUV recommended", note: "The classic temple circuit, for pilgrims focusing on darshan over photography." },
