...
export const routes: RouteData[] = [
  {
    ...
    planningNotes: [
      "Share your flight number on WhatsApp so the driver can track arrival and adjust pickup time for delays.",
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "The fare depends on your drop point and vehicle. Message us on WhatsApp with your hotel or area and we confirm the exact fare before the trip. The amount agreed is the amount you pay, and tolls or parking, where applicable, are listed upfront.",
      },
    ],
  ...
  },
  {
    ...
    description:
      "Private taxi from Varanasi to Sarnath for Dhamek Stupa, Mulagandha Kuti Vihara and the Sarnath Museum. Half-day or combined with local sightseeing.",
    answer:
    ...
    intro: [
      "Sarnath is where the Buddha gave his first sermon. Dhamek Stupa, Mulagandha Kuti Vihara, the Sarnath Museum and the Ashoka Pillar relics all sit in one compact complex, a short drive from Varanasi that works well as a half-day trip.",
    ...
    planningNotes: [
      ...
      "Sarnath Museum is closed on Fridays, so confirm the day if the museum matters to your visit.",
      ...
      "Comfortable footwear is sensible because there is some walking inside the deer park complex.",
    ],
    nearby: [
      { name: "Chaukhandi Stupa", note: "5 min from the main Sarnath site, a brief stop." },
    ...
    faqs: [
      {
        ...
        a: "Yes. A typical plan is Sarnath in the morning and Varanasi temples and evening ghats afterwards.",
      },
      {
  ...
  },
  {
    ...
    description:
      "Private taxi from Varanasi to Prayagraj for Triveni Sangam, Akshayavat and Anand Bhavan. One-way or same-day round trip. Call or WhatsApp to confirm.",
    answer:
    ...
    nearby: [
      ...
      { name: "Anand Bhavan", note: "Nehru family museum, a half-hour stop." },
    ],
    faqs: [
      {
  ...
  },
  {
    ...
    description:
      "Private taxi from Varanasi to Ayodhya for Ram Janmabhoomi, Hanuman Garhi and Saryu Ghat. One-day or two-day plan with comfortable vehicles.",
    answer:
    ...
    planningNotes: [
      ...
      "A two-day plan is far more relaxed: overnight in Ayodhya, complete darshan in the morning, return the next day.",
      "SUV/MUV is recommended for the 5–6 hour drive. For groups of 6+, a tempo traveller is better.",
      "Darshan timings at Ram Janmabhoomi shift periodically. We confirm them before your trip.",
    ],
    nearby: [
      { name: "Saryu Ghat aarti", note: "Evening aarti is a key experience if staying overnight." },
      { name: "Kanak Bhawan", note: "Close to Ram Mandir and easy to combine." },
  ...
  },
  {
    ...
    description:
      "Private taxi from Varanasi to Bodh Gaya and the Mahabodhi Temple, ~280 km via NH2/NH19. Comfortable SUV or Innova. Call or WhatsApp for availability.",
    answer:
    ...
    planningNotes: [
      ...
      "Highway tolls are paid separately at the plazas, and the driver lists them upfront so nothing is a surprise.",
    ],
    nearby: [
    ...
    faqs: [
      {
        ...
        a: "Technically possible but not recommended, because it means 12+ hours of driving and rushed darshan. An overnight in Bodh Gaya is far better.",
      },
      {
  ...
  },
  {
    ...
    description:
      "Private taxi from Varanasi to Vindhyachal for Vindhyavasini Devi and Ashtabhuja Temple, ~80 km. Same-day return or combine with Prayagraj.",
    answer:
    ...
    intro: [
      ...
      "From Varanasi the drive is about 80 km via Mirzapur. The road passes through Chunar (known for its fort) and is a straightforward two-hour drive in normal traffic. During Navratri the town gets extremely crowded, so advance vehicle booking is essential.",
    ],
    planningNotes: [
      ...
      "Combining Vindhyachal with Prayagraj is a popular two-day plan; Vindhyachal sits roughly midway between Varanasi and Prayagraj.",
    ],
    nearby: [
    ...
    faqs: [
      {
        ...
        a: "Year-round, but Chaitra and Sharad Navratri draw the largest crowds. If visiting during Navratri, book transport early because roads and parking fill up fast.",
      },
      {
        q: "Can I combine Vindhyachal with Prayagraj?",
        a: "Yes. Vindhyachal is roughly midway, so a common plan is Vindhyachal on day one, Prayagraj and the Sangam on day two, then return to Varanasi.",
      },
      {
  ...
  },
  {
    ...
    intro: [
      ...
      "The challenge isn't distance. It's parking, lane access and sequence. Old city temples like Kashi Vishwanath sit in narrow lanes where vehicles can't enter, so the driver drops you at the closest motorable point, waits, and picks you up after darshan. We plan the route so you move south-to-north (or reverse) without doubling back through traffic.",
    ],
    planningNotes: [
      "Start early, 6 am if possible, to reach Kashi Vishwanath before the main queue builds. Morning darshan is quieter.",
      "Kashi Vishwanath requires walking through the corridor from the nearest vehicle drop point (a 10–15 min walk). Leave heavy bags in the vehicle.",
      "Durga Temple and Tulsi Manas Mandir are next to each other near Durga Kund, so combine them in one stop.",
      "BHU's New Vishwanath Temple is campus-entry controlled. The driver drops you at the gate; campus is walkable and shaded.",
      "For elderly travellers we pace the schedule with breaks for chai and rest, and the driver stays close to minimise walking distances.",
    ],
    nearby: [
      ...
      { name: "Assi Ghat", note: "Quiet morning ghat, a good starting or ending point." },
    ],
    faqs: [
      {
      ...
      },
      {
        ...
        a: "Yes, and that's a key reason to have a private taxi. We pace the schedule, keep walking distances short, and the driver assists at each stop. SUV/MUV recommended for easier seating.",
      },
      {
  ...
  },
  {
    ...
    intro: [
      "A full day of Varanasi sightseeing typically covers the ghat waterfront, Sarnath (10 km north), BHU campus, and Ramnagar Fort across the river. Most travellers also want a sunrise boat ride on the Ganga and the evening aarti at Dashashwamedh Ghat, and the taxi plan works around both.",
    ...
    nearby: [
      ...
      { name: "Ramnagar Fort", note: "Across the Ganga, a historical fort and museum ~30 min from central Varanasi." },
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "The driver times the last stop so you reach the Dashashwamedh Ghat area by 6–6:30 pm. You walk to the ghat for the aarti while the driver waits at the nearest vehicle point.",
      },
      {
